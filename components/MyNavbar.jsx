  ...
  return (
    <div>
      <div className="container-fluid">
        <div className={`row py-2 text-center ${Navstyles.top_header_bg}`}>
          <div className="col-12 col-lg-12 col-md-12 col-sm-12">
            <span className={Navstyles.top_heading}>You’re browsing the documentation for v2.x and earlier.<a href="https://v3.vuejs.org/" className="text-decoration-none text-light fw-bold"> Click Here</a> for v3.x documentation.</span>
          </div>
        </div>
      </div>
